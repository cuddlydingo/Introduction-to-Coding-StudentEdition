...
- **Side-quest:** add a title banner to your welcome message using several `print()` lines of ASCII art.
- **Stuck?** each `print(...)` starts a new line; run the file with `python week01_p1_hello.py`.
